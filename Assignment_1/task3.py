...
def null_space_projection_from_pinv(J: np.ndarray) -> np.ndarray:
    """
    Проєкція у нуль-простір використовуючи псевдоінверсію (стабільно).
    """
...
if __name__ == "__main__":
    ...
    # --- СТАТИЧНІ початкові кути: перший варіант, обраний користувачем ---
    ...
    try:
        while running:
            ...
            if controller.is_idle():
                ...
                # Завершено всі фігури за один прохід
